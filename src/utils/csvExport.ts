...
export const exportSoldItemsCSV = (soldItemsData: any[], filename: string = 'sold-items.csv', includeCost: boolean = true): void => {
  const headers = [
    'saleDate',
    'saleId',
    'productName',
    ...
    'discount',
    'lineRevenue',
    ...(includeCost ? ['lineCost', 'grossProfit', 'profitMargin'] : []),
    'staffName',
    'flags'
  ];
